...
class LandingsControllerTest < ActionController::TestCase
  ...
  test "should create landing" do
    assert_difference('Landing.count') do
      post :create, landing: { dissatisfied: @landing.dissatisfied, do_something: @landing.do_something, other: @landing.other, preferance: @landing.preferance }
    end
  ...
  test "should update landing" do
    patch :update, id: @landing, landing: { dissatisfied: @landing.dissatisfied, do_something: @landing.do_something, other: @landing.other, preferance: @landing.preferance }
    assert_redirected_to landing_path(assigns(:landing))
  end
